...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel CssClass="PnlApresentacao col-9 col-md-9 col-sm-9 d-flex align-items-center justify-content-center" runat="server">
        <div class="row text-center">
            <asp:Label class="col-12 col-md-12 col-sm-12 " runat="server" Text="GCA"></asp:Label>
            <asp:Label class="col-12 col-md-12 col-sm-12" runat="server" Text="Gerenciador de Chaves de Ativação"></asp:Label>
